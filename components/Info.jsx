    ...
    <div className='max-w-7xl mx-auto px-2 py-8 grid md:grid-cols-2 gap-60'>
      ...
      <div className='flex flex-wrap gap-2 md:flex-col md:w-[880px]'>
        <div className='mb-6 bg-white p-6 md:p-8 shadow-md rounded-sm w-full'>
          ...
          <p className='text-lg'>
            This policy is designed specifically to protect the goods
            you&apos;re transporting while they&apos;re in transit. It covers
            loss, damage, or theft of the goods being transported, providing
            financial compensation to replace or repair them.
          </p>
        </div>
        ...
        <div className='mb-6 mt-4 bg-white p-6 rounded-sm shadow-md w-full'>
          <div className='flex justify-between items-center mb-4'>
            ...
            <button className='text-white bg-primary px-4 py-2 flex items-center'>
      ...
      {/* div 2 */}
      <div className='flex flex-wrap gap-20 md:flex-col ml-40 md:w-[1000px]'>
        <FormsD />
      </div>
    </div>
  );
